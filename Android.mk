...
include $(CLEAR_VARS)
LOCAL_LDLIBS     := -llog
LOCAL_CFLAGS     := -D'MOD_ID="PracticePlus"' -D'VERSION="0.1.0"' -I'c:/Program Files/Unity/Hub/Editor/2019.3.1f1/Editor/Data/il2cpp/libil2cpp'
LOCAL_MODULE     := practiceplus
